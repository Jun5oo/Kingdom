...
7x7 보드 위에서 진행하는 2인 전략 카드게임. 종족별 카드 효과와 배치 전략으로 상대의 왕을 먼저 처치하는 것이 목표입니다.

- **개발 기간**: 2025.05 ~ 2025.09
- **팀 구성**: 기획 1, 개발 2, 아트 1 (61315 GameLab)
- **담당**: 보드, 카드, UI, 카드 효과 시스템 (AI 제외 전 영역)
- **환경**: Unity / C# / UniTask
...
→ 원인 분석과 개선 방향은 포트폴리오에 정리했습니다: [Notion — Ability (카드 효과)](https://www.notion.so/261254fd242f80cdad00da80197e503c)
